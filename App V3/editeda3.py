...
sequenceCount = len(in_sequences);
...
def displayMatrixFileOutput():
    ...
    for i in range(matrix_Count):
        ...
        # Not first test Matrix
            ...
            for line in file:
                ...
                # for s in mergeSequences:
                #     print(s);

                # print(mergeSequences);
    ...
    # # First Matrix is easy, just list all the sequences
    # if(count == 1):

    #     for i in range(len(Matrix[0])):

    #         temp.append("S" + str(i+1));
    ...
    # # Second Matrix is harder, must list merged sequence and remaining sequences that are not merged
    # else:


    #     # Open Cluster  + count file
    #     file = open("Cluster.o" + str(count));
    ...
    #     sequencesTemp = sequencesTemp.split(" ");

    #     # print("Sequence Temp List:");
    #     # print(sequencesTemp);


    #     # Name first (0th) Column the first string in the file
    #     temp.append("S" + str(sequencesTemp[0]));
    ...
    # # Write matrix to file
    # print("Outputfile " + str(count) +":");
    # out1 = "displayMatrix.o" + str(count);
    # print(out1);
    # print("");
...
def matrixFileOutput(Matrix):
    ...
    # displayMatrixFileOutput(res, fileCount);
