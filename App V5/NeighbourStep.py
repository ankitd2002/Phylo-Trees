...
def initialStep():
    ...
    myLabel1 = Label(explain_frame, text = "We have " + str(len(listOfMatrices[0])) + " sequences.", anchor="e", justify=LEFT);
    myLabel1.config(font=("Courier", 13));
...
def printMatrix(Matrix):
    ...
    for x in Matrix:
        ...
        cell = 0;
        nextColumn = max(nextColumn, cell);
    ...
    if(iteration > -1):
        ...
        for x in listQMatrices[iteration]:
            myLabel1 = Label(matrix_frame, text = "-->", anchor="e", justify=LEFT, borderwidth=2, relief="groove", bg="yellow");
            myLabel1.grid(row=row, column=cell, sticky='ew');
            myLabel1.config(font=("Courier", 13));
        ...
        for x in listQMatrices[iteration]:
            ...
            # For each value in matrix row
            for val in x:

                myLabel1 = Label(matrix_frame, text = str(val), anchor="e", justify=LEFT, borderwidth=2, relief="groove");
                myLabel1.grid(row=row, column=cell, sticky='ew');
                myLabel1.config(font=("Courier", 13));
...
def nextStep():
    ...
    if(iteration >= matrixCount):
        ...
        myLabel1 = Label(explain_frame, text = "Minimum Q Value Is: ", anchor="e", justify=LEFT, background="#CCE4CA");
        myLabel1.grid(row=0, column=0);
        myLabel1.config(font=("Courier", 13));
...
# Title
root.title("Neighbour Joining Trees");
